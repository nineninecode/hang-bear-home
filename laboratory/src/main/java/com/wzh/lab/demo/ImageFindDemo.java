...
public class ImageFindDemo {
    ...
    public ImageFindDemo(String keyImagePath, String screenShotImagePath) {
        screenShotImage = this.getBfImageFromPath(screenShotImagePath);
        keyImage = this.getBfImageFromPath(keyImagePath);
        screenShotImageRGBData = this.getImageGRB(screenShotImage);
        keyImageRGBData = this.getImageGRB(keyImage);
        scrShotImgWidth = screenShotImage.getWidth();
    ...
    public static void main(String[] args) {
        String keyImagePath = "D:/img/part.png";
        String screenShotImagePath = "D:/img/full.png";
        ImageFindDemo demo = new ImageFindDemo(keyImagePath, screenShotImagePath);
